...
Config.Menu = {
    isOutMapChecked = true,             -- minimap her zaman görünür (RAGE MP)
    isOutCompassChecked = true,         -- pusula sadece araçta
    isCompassFollowChecked = true,
    isOpenMenuSoundsChecked = true,
    isResetSoundsChecked = true,
    isListSoundsChecked = true,
    isMapNotifChecked = false,          -- minimap yükleme bildirimi kapalı
    isLowFuelChecked = true,
    isCinematicNotifChecked = true,
    isDynamicHealthChecked = false,     -- can her zaman görünür
    isDynamicArmorChecked = false,      -- zırh her zaman görünür
    isDynamicHungerChecked = false,     -- açlık her zaman görünür
    isDynamicThirstChecked = false,     -- susuzluk her zaman görünür
    isDynamicStressChecked = true,
    isDynamicOxygenChecked = true,
    isChangeFPSChecked = true,
    isHideMapChecked = false,
    isToggleMapBordersChecked = false,  -- RAGE MP'de minimap kenarlığı yok
    isDynamicEngineChecked = true,
    isDynamicNitroChecked = true,
    isChangeCompassFPSChecked = true,
    isCompassShowChecked = false,       -- üst pusula kapalı (RAGE MP tarzı)
    isShowStreetsChecked = false,
