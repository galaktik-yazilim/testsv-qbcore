...
**Görevde (`onduty`) olmadan çalışmayan işlemler (script korumalı):**
- Kişi arama, ceza, hapish, el koyma, ehliyet alma
- Stash, delil, obje/spike, helikopter spotlight
- Parmak izi, takip cihazı

Görev dışı PD karakteri sivil gibi davranır; yalnızca `/911` alabilir (LEO olarak değil).
